...
> 8. **Feature tagging** — when a feature is completed, use `tag-feature` to label all relevant entities with the feature name. This enables impact analysis ("changing this file affects feature X").
>
> **Key commands:**
> ```
> dsp-cli init
...
> dsp-cli get-stats
> dsp-cli tag-feature <feature-name> <uid> [<uid> ...]
...
| Feature completed | `tag-feature` (label relevant entities with feature name) |
